...
}) (
    {
                ...
                if (e instanceof Array) {
                  for ((u = 0), (o = e.length); u < o; u++) {
                    ...
                    f +=
                        ...
                        '-' +
                        (p ? ' ' : '\n') +
                        this.dump (h, t - 1, p ? 0 : n + this.indentation, i, l) +
                        (p ? '\n' : '');
                  }
                } else {
                  for (a in e) {
      ...
      2: [
        function (e, t, n) {
          ...
          i = (function () {
            var e;
            function t(){}t.LIST_ESCAPEES=["\\","\\\\",'\\"','"',"\0","","","","","","","","\b","\t","\n","\v","\f","\r","","","","","","","","","","","","","","=String.fromCharCode(e(133),e(160),e(8232),e(8233))"];
            t.LIST_ESCAPED = [
              '\\\\',
              '\\"',
              '\\"',
            ...
            t.MAPPING_ESCAPEES_TO_ESCAPED = (function () {
              ...
              i = {};
              for (
                  (e = n = 0), (r = t.LIST_ESCAPEES.length);
                  0 <= r ? n < r : n > r;
                  e = 0 <= r ? ++n : --n
              ) {
            ...
            t.PATTERN_CHARACTERS_TO_ESCAPE = new r (
                '[\\x00-\\x1f]|Â�|Â |â�¨|â�©'
            );
            t.PATTERN_MAPPING_ESCAPEES = new r (
                t.LIST_ESCAPEES.join ('|').split ('\\').join ('\\\\')
            );
            t.PATTERN_SINGLE_QUOTING = new r (
                '[\\s\'":{}[\\],&*#?]|^[-?|<>=!%@`]'
            );
            ...
            t.escapeWithDoubleQuotes = function (e) {
              var t;
              t = this.PATTERN_MAPPING_ESCAPEES.replace (
                  e,
                  (function (e) {
                    return function (t) {
        ...
        function (e, t, n) {
          ...
          s = (function () {
            ...
            e.parse = function (e, t, n) {
              ...
              i = {exceptionOnInvalidType: t, objectDecoder: n, i: 0};
              switch (e.charAt (0)) {
                case '[':
      ...
      7: [
        function (e, t, n) {
          ...
          l = (function () {
            e.prototype.PATTERN_FOLDED_SCALAR_ALL = new u (
                '^(?:(?<type>![^\\|>]*)\\s+)?(?<separator>\\||>)(?<modifiers>\\+|\\-|\\d+|\\+\\d+|\\-\\d+|\\d+\\+|\\d+\\-)?(?<comments> +#.*)?$'
            );
            e.prototype.PATTERN_FOLDED_SCALAR_END = new u (
                '(?<separator>\\||>)(?<modifiers>\\+|\\-|\\d+|\\+\\d+|\\-\\d+|\\d+\\+|\\d+\\-)?(?<comments> +#.*)?$'
            );
            e.prototype.PATTERN_SEQUENCE_ITEM = new u (
                '^\\-((?<leadspaces>\\s+)(?<value>.+?))?\\s*$'
            );
            e.prototype.PATTERN_ANCHOR_VALUE = new u (
                '^&(?<ref>[^ ]+) *(?<value>.*)'
            );
            e.prototype.PATTERN_COMPACT_NOTATION = new u (
                '^(?<key>' +
                i.REGEX_QUOTED_STRING +
                '|[^ \'"\\{\\[].*?) *\\:(\\s+(?<value>.+?))?\\s*$'
            );
            e.prototype.PATTERN_MAPPING_ITEM = new u (
                '^(?<key>' +
                i.REGEX_QUOTED_STRING +
                '|[^ \'"\\[\\{].*?) *\\:(\\s+(?<value>.+?))?\\s*$'
            );
            ...
            e.prototype.PATTERN_YAML_HEADER = new u (
                '^\\%YAML[: ][\\d\\.]+.*\n',
                'm'
            );
            ...
            e.prototype.PATTERN_DOCUMENT_MARKER_END = new u (
                '^\\.\\.\\.\\s*$',
                'm'
            );
            ...
            e.prototype.parse = function (t, n, s) {
              ...
              while (this.moveToNextLine ()) {
                ...
                if ((Q = this.PATTERN_SEQUENCE_ITEM.exec (this.currentLine))) {
                  ...
                  if (
                      Q.value != null &&
                      (b = this.PATTERN_ANCHOR_VALUE.exec (Q.value))
                  ) {
                    N = b.ref;
                    Q.value = b.value;
                  }
                  if (
                    ...
                    if (
                      ...
                      X.refs = this.refs;
                      h.push (
                          X.parse (this.getNextEmbedBlock (null, true), n, s)
                      );
                    } else {
                      h.push (null);
                    }
                    ...
                    if (
                        ((F = Q.leadspaces) != null ? F.length : void 0) &&
                        (b = this.PATTERN_COMPACT_NOTATION.exec (Q.value))
                    ) {
                    ...
                    (Q = this.PATTERN_MAPPING_ITEM.exec (this.currentLine)) &&
                    Q.key.indexOf (' #') === -1
                ) {
                  ...
                  if ('<<' === x) {
                    ...
                    u = true;
                    if (
                        ((k = Q.value) != null ? k.indexOf ('*') : void 0) === 0
                    ) {
                      j = Q.value.slice (1);
                      if (this.refs[j] == null) {
                        throw new r (
                            'Reference "' + j + '" does not exist.',
                            this.getRealCurrentLineNb () + 1,
                            this.currentLine
                        );
                      }
            ...
            e.prototype.getCurrentLineIndentation = function () {
              return (
                  this.currentLine.length - a.ltrim (this.currentLine, ' ').length
              );
            };
            e.prototype.getNextEmbedBlock = function (e, t) {
              ...
              while (this.moveToNextLine ()) {
                ...
                if (i >= l) {
                  n.push (this.currentLine.slice (l));
                } else if (a.ltrim (this.currentLine).charAt (0) === '#') {
                } else if (0 === i) {
                  this.moveToPreviousLine ();
                  break;
                } else {
            ...
            e.prototype.cleanup = function (e) {
              ...
              t = 0;
              (c = this.PATTERN_YAML_HEADER.replaceAll (e, '')), (e = c[0]), (t =
                  c[1]);
              this.offset += t;
              (h = this.PATTERN_LEADING_COMMENTS.replaceAll (e, '', 1)), (T =
                  h[0]), (t = h[1]);
              if (t === 1) {
                this.offset += a.subStrCount (e, '\n') - a.subStrCount (T, '\n');
                e = T;
              }
              (p = this.PATTERN_DOCUMENT_MARKER_START.replaceAll (e, '', 1)), (T =
                  p[0]), (t = p[1]);
              if (t === 1) {
                this.offset += a.subStrCount (e, '\n') - a.subStrCount (T, '\n');
                e = T;
        ...
        function (e, t, n) {
          ...
          r = (function () {
            ...
            e.unescapeDoubleQuotedString = function (e) {
              ...
              return this.PATTERN_ESCAPED_CHARACTER.replace (
                  e,
